...
import pickle
import numpy as np
from problems.tpsc.state_tpsc import StateTPSC
...
class TPSC(object):
    NAME = 'tpsc'  # Capacitated Vehicle Routing Problem
    ...
    def make_dataset(*args, **kwargs):
        ...
        return TPSCDataset(*args, **kwargs)

    @staticmethod
    def make_state(*args, **kwargs):
        return StateTPSC.initialize(*args, **kwargs)
            ...
            if is_dynamic:
                ...
                for i in range(num_samples):
                    ...
                    case_info = {
                        ...
                        'w_capacity': torch.randint(1, 30, (max_n_agent, 1), dtype=torch.float,
