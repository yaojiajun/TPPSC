...
def run(opts):
    ...
    if not opts.no_tensorboard:
        tb_logger = TbLogger(os.path.join(opts.log_dir, "{}_{}".format(opts.problem, opts.tasks_size), opts.run_name))
    ...
    val_dataset = problem.make_dataset(
        size_t=opts.tasks_size, size_w=opts.workers_size, num_samples=opts.val_size, filename=opts.val_dataset, distribution=opts.data_distribution)
